...
const ComponentB = () => {
  ...
  return (
    <div className="axios">
      ...
      <button className="btn btn-primary" onClick={addNewUser}>Add a new user</button>
      <button className="btn btn-warning" onClick={updateExistingUser}>Update an user</button>
      <button className="btn btn-danger" onClick={deleteUser}>Delete an user</button>
